...
namespace RatingSystem.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMediatR(new[] { typeof(GetAverageRating).Assembly, typeof(AllEventsHandler).Assembly }); // get all IRequestHandler and INotificationHandler classes
...
#pragma warning restore MVC1005 // Cannot use UseMvc with Endpoint Routing.
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Rating System Api");
